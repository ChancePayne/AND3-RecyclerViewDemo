package com.lambdaschool.recyclerviewdemo.adapter
...
class ConversationListAdapter(val data: MutableList<Conversation>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val viewGroup = LayoutInflater.from(parent.context).inflate(R.layout.conversation_item_layout, parent, false)
